...
class TestUsers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_user = User(name = "levert", password = "levo")
    ...
    def test_init(self):
        ...
        """
        self.assertEquals(self.new_user.name,"levert")
